...
public class ExpenseTransaction {
    ...
    public ExpenseTransaction(AppUser user, String merchantName, String description,
                              BigDecimal amount, Category category, String aiSuggestedCategory,
                              double aiConfidence, PaymentStatus status, LocalDateTime occurredAt) {
        this.user = user;
