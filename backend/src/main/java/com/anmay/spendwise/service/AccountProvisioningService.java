...
public class AccountProvisioningService {
    ...
    public AccountProvisioningService(WalletRepository walletRepository,
    ...
    public void provision(AppUser user, BigDecimal walletBalance) {
        ...
        DEFAULT_CATEGORIES.forEach((name, icon) -> categories.computeIfAbsent(name,
                ignored -> categoryRepository.save(new Category(user, name, icon, true))));
    ...
    private void createBudgetIfMissing(AppUser user, Category category, String limit, int warningPercent) {
